...
namespace LibGDXExampleGame
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            textureAtlas = Content.Load<List<TextureAtlas>>("TextAtlas");
        }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(textureAtlas[0].GetRegion(0), new Vector2(100, 100), Color.AliceBlue);
            spriteBatch.End();
